...
const protect = async (req, res, next) => {
  ...
  if (
    ...
    try {
      ...
      // Account status verification check bypassed (users are auto-verified)
...
const seekerOnly = (req, res, next) => {
  if (req.user && req.user.role === 'seeker') {
    ...
    res.status(403).json({ message: 'Not authorized, seeker only' });
  }
};

module.exports = { protect, adminOnly, ownerOnly, seekerOnly };
